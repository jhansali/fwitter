...
import { determineStyledInputBorder, determineStyledLabelColor } from "../../utils/DetermineStyledUtil";
...
export const StyledInputLabel = styled.label<StyledInputProps>`
    position: absolute;
    left: 10px;
    font-weight: 400;
    width: 100%;
    ...
    color: ${(props) => determineStyledLabelColor(props)};
`;